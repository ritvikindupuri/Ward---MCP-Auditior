...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sable scans your GitHub repositories with a multi-agent system: dependency CVEs, leaked secrets, supply-chain risk, and maintainer OSINT — judged by an LLM and delivered as a professional PDF report." },
